<template>
	<el-main>
		<div>
			<el-button type="success" class="el-icon-edit" @click="switchpage">编辑标准项</el-button>
			 ...
			 :tree-props="{children: 'children'}">
				...
				<el-table-column prop="state" label="状态" sortable width="120">
					<template slot-scope="scope">
						...
						<el-tag type="warning" effect="dark" v-if="scope.row.state==true">必选</el-tag>
					</template>
				</el-table-column>
			...
			<el-button type="primary" class="el-icon-download">下载附件</el-button>
